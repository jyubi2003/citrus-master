...
public class CreateNewTranActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_new_tran);
    ...
    public static Intent createIntent(Context context, String groupName) {
        Intent intent = new Intent(context, CreateNewTranActivity.class);
